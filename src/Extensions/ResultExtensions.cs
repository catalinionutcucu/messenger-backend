...
{
    /// <summary>
    /// Maps the result to a value of type <c>TMap</c> by executing the corresponding function based on whether the result is success or failure
    /// </summary>
    /// <returns>The value of type <c>TMap</c> based on whether the result is success or failure</returns>
    ...
    /// <summary>
    /// Maps the result to a value of type <c>TMap</c> by executing the corresponding asynchronous function based on whether the result is success or failure
    /// </summary>
    /// <returns>The value of type <c>TMap</c> based on whether the result is success or failure</returns>
    ...
    /// <summary>
    /// Executes the corresponding function based on whether the result is success or failure
    /// </summary>
    ...
    /// <summary>
    /// Executes the corresponding asynchronous function based on whether the result is success or failure
    /// </summary>
